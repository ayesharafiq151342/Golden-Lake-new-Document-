  ...
  return (
    <footer className="bg-purple-700 mt-20 text-white py-10 px-5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-xl font-bold border-l-4 border-purple-400 pl-2 mb-4">Quick Links</h3>
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="hover:text-purple-400">About Us</a></li>
            <li><a href="#" className="hover:text-purple-400">Terms of Services</a></li>
        ...
        {/* Short Links */}
        <div>
          <h3 className="text-xl font-bold border-l-4 border-purple-400 pl-2 mb-4">Short Links</h3>
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="hover:text-purple-400">ERP Modules</a></li>
            <li><a href="#" className="hover:text-purple-400">HR and Payroll</a></li>
            <li><a href="#" className="hover:text-purple-400">Point of Sale</a></li>
            <li><a href="#" className="hover:text-purple-400">Textile Management System</a></li>
            <li><a href="#" className="hover:text-purple-400">Cash Management System</a></li>
        ...
        {/* Contact Us */}
        <div>
          <h3 className="text-xl font-bold border-l-4 border-purple-400 pl-2 mb-4">Contact Us</h3>
          ...
          <div className="flex space-x-4 mt-4 text-xl">
            ...
            <a href="#" className="hover:text-purple-400"><Youtube className="w-5 h-5" /></a>
