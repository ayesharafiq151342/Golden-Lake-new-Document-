...
function Manage_system() {
  ...
  return (
    <>
      ...
      style={{ backgroundImage: "url('/mani-page3.webp')", backgroundColor: "rgb(130, 128, 127)", backgroundBlendMode: "multiply" }}
    >
      <div className="w-full max-w-7xl  md:p-8 rounded-lg flex flex-col md:flex-row gap-8 p-6">
        ...
        <div className="flex-1 m-auto text-center md:text-start">
          ...
          <a href="#demo" className="bg-purple-500 text-white px-6 py-2 rounded-lg mt-4 inline-block">
            Get Free Demo
          </a>
        </div>
