    ...
    <>
      ...
      >
        ...
        <div className="relative w-full max-w-7xl md:p-8 rounded-lg flex flex-col md:flex-row gap-8 p-6">
          ...
          <div className="flex-1 text-center md:text-start">
            ...
            <p className="text-sm sm:text-base md:text-lg text-justify text-white"></p>
            {/* Contact Button */}
            <Button
              label="Get Free Demo"
              variant="secondary"
      ...
      <div className="lg:w-9/12 w-full  mx-auto p-6 text-gray-900 dark:text-white">
        ...
        <div className="p-6   mx-auto  space-y-6">
          ...
          Account Payable SystemStandard Invoice</h2>
          ...
          <p className="text-justify">
          A credit memo is a short form of a memorandum, a statement delivered by a supplier of goods or services to the customer that reduces the amount due to the seller under the conditions of a previous invoice.A credit memo is a short form of a memorandum, a statement delivered by a supplier of goods or services to the customer that reduces the amount due to the seller under the conditions of a previous invoice. 
       
          </p>

          <h3 className="font-semibold">Prepayments
          </h3>
          <p className="text-justify">
          ...
          <p className="text-justify">
          Small company owners are particularly fond of cash invoicing. A cash invoice is a statement of a selling transaction that occurred, issued when the payment system is cash.      </p>
          ...
          <p className="text-justify">
          A firm that invoices its consumer for the purchase of products and finally the services through invoice is referred to as ‘Payable by Invoice. It generates after the GRN number. Moreover, the invoice contains crucial information, such as the price of goods received and services performed. As well as additional charges, company data, and a due date.    </p>
          ...
          <p className="text-justify">
          A withholding tax is sometimes known as a retention tax. Furthermore, it is a legal requirement that requires the client’s payer—further, the invoice—to withhold or reduce the tax from the payment and remit it to the state.     </p>
           <h3 className="font-semibold">Payments</h3>
          <p className="text-justify">
          Payment is made based on invoices of products and services that have been decided upon by all parties concerned. Furthermore, payments can be made in cash, by cheque, wire transfer, line of credit, direct debit, post-dated cheque, etc.</p>
          ...
          <h3 className="font-semibold mt-4">Account Payable System Aging Report</h3>
          <p className="text-justify">
          The report aims to help the user identify which bills are past due. Moreover, it’s essential for a company that wants to keep track of whose payables must be paid on time. Furthermore, the Golden Lake ERP Module was responsible for the best possible service to your business.

Given these points</p>
<h3 className="font-semibold">Supplier aging report</h3>
          <p className="text-justify">
          The Supplier Aging report lists the outstanding vendor balances. Moreover, they may be categorized by date interval or aging period description.</p>
<h3 className="font-semibold">Supplier ledger</h3>
          <p className="text-justify">
          All transactions connected to every supplier are recorded in the supplier ledgers, including all invoices produced and paid from the beginning.</p>
          <h3 className="font-semibold">Unpaid invoices report</h3>
          <p className="text-justify">
          The Golden Lake services give an unpaid invoice report solution that automates the process, allowing you to spend less time tracking unpaid bills and concentrating more on what matters most.
          </p>
          <h3 className="font-semibold">Supplier closing report</h3>
         <p className="text-justify"> This report displays the balance for a single item of opening and closing. Further, the details of suppliers are saved in ERP Golden Lake software, with the principal supplier and item ID used to sort the listings. </p>
           <h3 className="font-semibold">Supplier invoices </h3>
          <p className="text-justify">
          A supplier invoice is a bill that a seller sends to a client for products delivered and further services done. It lists the products and services sold to clients and any payroll taxes and shipping costs spent during the transaction. </p>
          </div>   </div>
      <Footer />
    </>
  );
