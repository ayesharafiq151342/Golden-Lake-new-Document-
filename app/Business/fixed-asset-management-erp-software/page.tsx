      ...
      >
        ...
        <div className="relative w-full max-w-7xl md:p-8 rounded-lg flex flex-col md:flex-row gap-8 p-6">
          ...
          <div className="flex-1 text-center md:text-start">
            ...
            <p className="text-sm sm:text-base md:text-lg text-white">Elevate asset control with Golden LakeERP. Streamline Fixed Asset Management for precise tracking and automated reporting.</p>
            {/* Contact Button */}
            <Button
              label="Get Free Demo"
              variant="secondary"
